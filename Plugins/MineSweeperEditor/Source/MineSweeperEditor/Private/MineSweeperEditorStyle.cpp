...
void FMineSweeperEditorStyle::Init()
{
...
FName FMineSweeperEditorStyle::GetName()
{
...
TSharedRef< FSlateStyleSet > FMineSweeperEditorStyle::Create()
{
	TSharedRef< FSlateStyleSet > Style = MakeShareable(new FSlateStyleSet("MineSweeperEditorStyle"));
	Style->SetContentRoot(IPluginManager::Get().FindPlugin("MineSweeperEditor")->GetBaseDir() / TEXT("Resources"));
...
void FMineSweeperEditorStyle::ReloadTextures()
{
...
const ISlateStyle& FMineSweeperEditorStyle::Get()
{
	return *StyleContext;
}
